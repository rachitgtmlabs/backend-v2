...
let ExpenseCategoriesController = class ExpenseCategoriesController {
    ...
    update(categoryId, portfolioId, dto) {
        return this.svc.updateCustom((0, require_query_1.requireQuery)(portfolioId, 'portfolio_id'), categoryId, dto);
    }
    delete(categoryId, portfolioId) {
        return this.svc.deleteCustom((0, require_query_1.requireQuery)(portfolioId, 'portfolio_id'), categoryId);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, category_dto_1.UpdateCategoryDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ExpenseCategoriesController.prototype, "delete", null);
exports.ExpenseCategoriesController = ExpenseCategoriesController = __decorate([
    (0, common_1.Controller)('cam/categories'),
